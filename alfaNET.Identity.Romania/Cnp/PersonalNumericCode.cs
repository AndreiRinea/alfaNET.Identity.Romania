...
namespace alfaNET.Identity.Romania.Cnp
{
    ...
    public class PersonalNumericCode : IEquatable<PersonalNumericCode>, IComparable<PersonalNumericCode>
    {
        ...
        private static readonly DateTime MaxDateForSector7And8 = new DateTime(1979, 12, 19);
        ...
        public ValidationErrors Validate()
        {
            ...
            {
                var date = new DateTime(dateComponents.Year, dateComponents.Month, dateComponents.Day);
